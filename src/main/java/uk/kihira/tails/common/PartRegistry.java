...
public class PartRegistry {
    ...
    static {
        ...
        //Ears
        addPart(new Part(UUID.fromString("7ee6ceb1-bcbf-44f3-98a5-969094f7f1d6"), "Fox Ears", "Adeon", MountPoint.HEAD, new int[]{0, 0, 0}), new LegacyPartRenderer(new ModelFoxEars(0)));
        addPart(new Part(UUID.fromString("4721ab6b-aaf6-4f56-9b2d-c5feb019b430"), "Alternate Fox Ears", "", MountPoint.HEAD, new int[]{0, 0, 0}), new LegacyPartRenderer(new ModelFoxEars(1)));
