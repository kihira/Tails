...
public class ModelBirdTail extends ModelPartBase {
    final LegacyModelRenderer center;
    final LegacyModelRenderer left0;
    final LegacyModelRenderer left1;
    final LegacyModelRenderer left2;
    final LegacyModelRenderer right0;
    final LegacyModelRenderer right2;
    final LegacyModelRenderer right1;

    public ModelBirdTail() {
        center = new LegacyModelRenderer(this, 0, 0);
        ...
        right1 = new LegacyModelRenderer(this, 0, 19);
        ...
        right2 = new LegacyModelRenderer(this, 6, 19);
