...
public class ModelDragonTail extends ModelPartBase {
    ...
    private final LegacyModelRenderer tailSubBase;
    private final LegacyModelRenderer tailSub1;
    private final LegacyModelRenderer tailSub2;
    private final LegacyModelRenderer tailSub3;

    public ModelDragonTail() {
        this.tailBase = new LegacyModelRenderer(this, 22, 0);
        this.tailBase.addBox(-2.5F, -2.5F, -2F, 5, 5, 8);
        this.setRotationDegrees(this.tailBase, -40F, 0F, 0F);

        this.tail1 = new LegacyModelRenderer(this, 0, 0);
        this.tail1.addBox(-2F, -2F, 0F, 4, 4, 7);
        this.tail1.setRotationPoint(0F, 0.3F, 5F);
        this.setRotationDegrees(this.tail1, -8F, 0F, 0F);

        this.tail2 = new LegacyModelRenderer(this, 0, 11);
        this.tail2.addBox(-1.5F, -1.5F, 0F, 3, 3, 8);
        this.tail2.setRotationPoint(0F, 0.2F, 5.5F);
        this.setRotationDegrees(this.tail2, 10F, 0F, 0F);

        this.tail3 = new LegacyModelRenderer(this, 0, 22);
        ...
        this.tailSubBase = new LegacyModelRenderer(this, 22, 5);
        this.tailSubBase.addBox(0F, -7.25F, -2F, 0, 5, 8);
        this.setRotationDegrees(this.tailSubBase, -40F, 0F, 0F);

        this.tailSub1 = new LegacyModelRenderer(this, 22, 11);
        ...
        this.tailSub2 = new LegacyModelRenderer(this, 22, 15);
        ...
        this.tailSub3 = new LegacyModelRenderer(this, 29, 6);
