...
public class ModelSharkTail extends ModelPartBase {
    ...
    public LegacyModelRenderer tailBase;
    public LegacyModelRenderer tail1;
    public LegacyModelRenderer fin;
    public LegacyModelRenderer tail2;
    public LegacyModelRenderer tail3;
    public LegacyModelRenderer finBase;
    public LegacyModelRenderer finTop1;
    public LegacyModelRenderer finBot1;
    public LegacyModelRenderer finTop2;
    public LegacyModelRenderer finTop3;
    public LegacyModelRenderer finBot2;
    public LegacyModelRenderer fubBot3;

    public ModelSharkTail() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.finBot1 = new LegacyModelRenderer(this, 26, 27);
        ...
        this.tailBase = new LegacyModelRenderer(this, 0, 24);
        ...
        this.tail2 = new LegacyModelRenderer(this, 0, 9);
        ...
        this.finTop1 = new LegacyModelRenderer(this, 16, 10);
        ...
        this.finTop3 = new LegacyModelRenderer(this, 16, 1);
        ...
        this.finBase = new LegacyModelRenderer(this, 16, 21);
        ...
        this.finBot2 = new LegacyModelRenderer(this, 26, 21);
...
/*        this.fin = new LegacyModelRenderer(this, 58, 0);
        ...
        this.tail3 = new LegacyModelRenderer(this, 0, 3);
        ...
        this.finTop2 = new LegacyModelRenderer(this, 16, 4);
        ...
        this.fubBot3 = new LegacyModelRenderer(this, 26, 17);
     ...
     */
    public void setRotateAngle(LegacyModelRenderer LegacyModelRenderer, float x, float y, float z) {
        LegacyModelRenderer.rotateAngleX = x;
        LegacyModelRenderer.rotateAngleY = y;
        LegacyModelRenderer.rotateAngleZ = z;
    }

        public void render(LivingEntity entity, int subtype, float partialTicks) {
