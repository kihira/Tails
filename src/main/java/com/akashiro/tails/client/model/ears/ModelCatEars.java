...
public class ModelCatEars extends ModelPartBase {
    ...
    final LegacyModelRenderer leftEarBottom;
    final LegacyModelRenderer leftEarRearTop;
    final LegacyModelRenderer leftEarRearLayer1;
    final LegacyModelRenderer leftEarRearBottom;
    final LegacyModelRenderer leftEarLayer1;
    final LegacyModelRenderer leftEarTop;
    final LegacyModelRenderer leftEarLayer3;
    final LegacyModelRenderer leftEarLayer2;
    final LegacyModelRenderer rightEarBottom;
    final LegacyModelRenderer rightEarLayer1;
    final LegacyModelRenderer rightEarRearTop;
    final LegacyModelRenderer rightEarRearLayer1;
    final LegacyModelRenderer rightEarRearBottom;
    final LegacyModelRenderer rightEarLayer2;
    final LegacyModelRenderer rightEarTop;
    final LegacyModelRenderer rightEarLayer3;

    public ModelCatEars() {
        textureWidth = 64;
        textureHeight = 32;

        leftEarBottom = new LegacyModelRenderer(this, 0, 0);
        ...
        leftEarRearTop = new LegacyModelRenderer(this, 0, 16);
        ...
        leftEarRearLayer1 = new LegacyModelRenderer(this, 0, 14);
        ...
        leftEarRearBottom = new LegacyModelRenderer(this, 0, 12);
        ...
        leftEarLayer1 = new LegacyModelRenderer(this, 0, 2);
        ...
        leftEarTop = new LegacyModelRenderer(this, 0, 8);
        ...
        leftEarLayer3 = new LegacyModelRenderer(this, 0, 6);
        ...
        leftEarLayer2 = new LegacyModelRenderer(this, 0, 4);
        ...
        rightEarBottom = new LegacyModelRenderer(this, 13, 0);
        ...
        rightEarLayer1 = new LegacyModelRenderer(this, 13, 2);
        ...
        rightEarRearTop = new LegacyModelRenderer(this, 13, 16);
        ...
        rightEarRearLayer1 = new LegacyModelRenderer(this, 13, 14);
        ...
        rightEarRearBottom = new LegacyModelRenderer(this, 13, 12);
        ...
        rightEarLayer2 = new LegacyModelRenderer(this, 13, 4);
        ...
        rightEarTop = new LegacyModelRenderer(this, 13, 8);
        ...
        rightEarLayer3 = new LegacyModelRenderer(this, 13, 6);
